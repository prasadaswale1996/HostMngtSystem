...
<html>
  ...
  <body>
    <h2>Spring3MVC with Hibernate3 For -> Host Management System</h2>
    <h2>1. <a href="employees.html">List of Employees</a></h2>
    <h2>2. <a href="add.html">Add Employee</a></h2>
    <h2>3. <a href="filter.html">Select Filters For Server List</a></h2>
    <%-- <h2>3. <a <%@ include file='filter.jsp' %>>  </a></h2>      --%>
  </body>
</html>